 ...
 * contract. See `.vibe/decisions/007-i18n-integration-approach.md` for why
...
export const NAMESPACE = "lifebar-viewer-web";
 ...
 * OpenKakutou app on that origin. See `.vibe/decisions/007`.
 */
const STORAGE_KEY = "lifebar-viewer-web-locale";
