...
// openkakutou/sff for a pinned version tag — the same download-not-build
// approach character-viewer-web already established for its own `character`
// WASM dependency (see its .vibe/backlog/done/001-wasm-release-download-script.md
// and .vibe/decisions/001-wasm-download-script-design.md), ported here for sff.
